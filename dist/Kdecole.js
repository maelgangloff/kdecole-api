...
class Kdecole {
     ...
     * ```
     */
    static async login(username, password, appVersion = exports.APP_VERSION) {
        const activation = new Activation_1.default(await Kdecole.kdecole(new Kdecole('', appVersion, 0), {
            service: 'activation',
